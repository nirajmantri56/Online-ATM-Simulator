...
public class SignUpTwo4 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        String sreligion = (String)religion.getSelectedItem();      //sreligion --> string of religion(It is a simple name, we can give anything).
...
//            } 
                ...
                //SignUp3 Object
                setVisible(false);
                new SignUpThree5(formno).setVisible(true);
        } catch(Exception ae){
